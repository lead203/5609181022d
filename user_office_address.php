							...
							<div class="uofb cf">
								<div class="l_col adrs">
									...
									<form method="POST">
										<div class="field">
											<label>Name *</label>
											<input type="text" name="name" palceholder="Name" class="vl_empty" />
										</div>
										<div class="field">
											<label>Your city *</label>
											<select name ="city" class="vl_empty">
												<option value="0" class="plh" selected></option>
										...
										<div class="field">
											...
											<select name ="area">
												<option value = "0" class="plh"></option>
											</select>
										</div>
										
										<div class="field">
											<label>Street</label>
											<input type="text" name="street" palceholder="street" class="vl_empty" />
										</div>
										<div class="field">
											<label>House # </label>
